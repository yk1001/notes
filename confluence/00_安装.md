1,下载docker
---
	docker pull registry.cn-hangzhou.aliyuncs.com/docker-org/confluence-server:6.6
...
---
	...
	sudo docker run --user root -d --name confluence -p 8090:8090 -v /var/atlassian/confluence:/var/atlassian/confluence registry.cn-hangzhou.aliyuncs.com/docker-org/confluence-server:6.6
5,配置数据库和密钥
---
